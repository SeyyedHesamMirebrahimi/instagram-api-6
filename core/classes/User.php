...
class User {
                ...
                <div class="dropdown">
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="admin/user-view/' . $target_id . '"><i class="fa fa-fw fa-eye"></i> ' . $language->global->view . '</a>
                            <a class="dropdown-item" href="admin/user-edit/' . $target_id . '"><i class="fa fa-fw fa-pencil-alt"></i> ' . $language->global->edit . '</a>
                            <a class="dropdown-item" data-confirm="' . $language->global->info_message->confirm_delete . '" href="admin/users-management/delete/' . $target_id . '/' . Security::csrf_get_session_token('url_token') . '"><i class="fa fa-fw fa-times"></i> ' . $language->global->delete . '</a>
                        </div>
                    </a>
                </div>';
            ...
            case 'page' :
                ...
                <div class="dropdown">
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="admin/page-edit/' . $target_id . '"><i class="fa fa-fw fa-pencil-alt"></i> ' . $language->global->edit . '</a>
                            <a class="dropdown-item" data-confirm="' . $language->global->info_message->confirm_delete . '" href="admin/pages-management/delete/' . $target_id . '/' . Security::csrf_get_session_token('url_token') . '"><i class="fa fa-fw fa-times"></i> ' . $language->global->delete . '</a>
                        </div>
                    </a>
                </div>';
            ...
            case 'proxy' :
                ...
                <div class="dropdown">
                    <a href="#" data-toggle="dropdown" class="text-secondary dropdown-toggle dropdown-toggle-simple">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <a class="dropdown-item" href="proxies_management/test/' . $target_id . '/' . Security::csrf_get_session_token('url_token') . '"><i class="fa fa-fw fa-plug"></i> ' . $language->admin_proxies_management->button->test . '</a>
                            <a class="dropdown-item" href="proxy_edit/' . $target_id . '"><i class="fa fa-fw fa-pencil-alt"></i> ' . $language->global->edit . '</a>
                            <a class="dropdown-item" data-confirm="' . $language->global->info_message->confirm_delete . '" href="proxies_management/delete/' . $target_id . '/' . Security::csrf_get_session_token('url_token') . '"><i class="fa fa-fw fa-times"></i> ' . $language->global->delete . '</a>
                        </div>
                    </a>
                </div>';
	...
	public static function generate_go_back_button($default = 'index') {
		...
		return '<a href="' . $settings->url . $default . '"><button class="btn btn-primary btn-sm btn-get-back" data-toggle="tooltip" title="'. $language->global->go_back_button . '"><i class="fa fa-fw fa-arrow-left"></i></button></a>';
	}
