                ...
                <div class="d-flex flex-column justify-content-center">
                    ...
                    <h3 class="text-right">
                        ...
                        <?php if($source_account_one->is_private): ?>
                            <span data-toggle="tooltip" title="<?= $language->report->display->private ?>"><i class="fa fa-fw fa-lock user-private-badge"></i></span>
                        <?php endif ?>
        ...
        <table class="table table-responsive-md">
            ...
            <tr>
                <th>
                    ...
                    <span data-toggle="tooltip" title="<?= $language->compare->display->engagement_rate_help ?>"><i class="fa fa-fw fa-question-circle text-muted"></i></span>
                </th>
            ...
            <tr>
                <th>
                    ...
                    <span data-toggle="tooltip" title="<?= sprintf($language->compare->display->average_likes_help, $settings->instagram_calculator_media_count) ?>"><i class="fa fa-fw fa-thumbs-up text-muted"></i></span>
                </th>
            ...
            <tr>
                <th>
                    ...
                    <span data-toggle="tooltip" title="<?= sprintf($language->compare->display->average_comments_help, $settings->instagram_calculator_media_count) ?>"><i class="fa fa-fw fa-comments text-muted"></i></span>
                </th>
