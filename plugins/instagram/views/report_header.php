...
<div class="d-flex flex-column flex-sm-row flex-wrap margin-bottom-6" style="color:white">
    ...
    <div class="col-sm-8 col-md-9 col-lg-6 pl-sm-0 d-flex justify-content-center justify-content-sm-start">
        <div class="row d-flex flex-column">
            <p class="m-0">
                <a href="<?= 'https://instagram.com/' . $source_account->username ?>" target="_blank" class="text-dark" rel="nofollow" style="color:white !important"><?= '@' . $source_account->username ?></a>
            </p>
            ...
            <div class="d-flex flex-row">
                ...
                <?php if($source_account->is_private): ?>
                    <span class="align-self-center ml-3" data-toggle="tooltip" title="<?= $language->instagram->report->display->private ?>"><i class="fa fa-fw fa-lock user-private-badge"></i></span>
                <?php endif ?>

                <?php if($source_account->is_verified): ?>
                    <span class="align-self-center ml-3" data-toggle="tooltip" title="<?= $language->instagram->report->display->verified ?>"><i class="fa fa-fw fa-check-circle user-verified-badge"></i></span>
                <?php endif ?>

                <?php if(User::logged_in()): ?>
                    <a href="#" id="favorite" onclick="return favorite(event)" data-id="<?= $source_account->id ?>" data-source="instagram"  style="color:white !important" class="align-self-center ml-3 card-link text-dark favorite-badge">
