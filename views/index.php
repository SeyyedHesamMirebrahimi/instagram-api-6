    ...
    <div class="container">
        ...
        <div class="row index-row">
            <div class="col-12">
                ...
                <h1 class="index-heading" data-aos="fade-down">Find top Instagram influencers to work with<?php // $settings->title ?></h1>
                ...
                <div class="index-search" data-aos="fade-down" data-aos-delay="300">
                    <form class="form-inline d-inline-flex search_form" action="" method="POST">
                        ...
                        <div class="index-input-div">
                            <i class="fa fa-fw fa-search index-search-input-icon"></i>
                            <input class="form-control index-search-input border-0 form-control-lg source_search_input" name="query" type="text" placeholder="<?= $language->{reset($sources)}->global->search_placeholder ?>" aria-label="<?= $language->{reset($sources)}->global->search_placeholder ?>">
                        </div>
...
<div class=" container-fluid main-wraper animated fadeIn">
    <?php 
    if(isset($search_results)){
    ?>
    <div class="container index-container-margin-top-big" id="sear-res">
        <h2>Search Results</h2>
        <?php require VIEWS_ROUTE . 'shared_includes/widgets/search_results.php' ?>
    </div>    
    <?php    
    } else {
    ?>
        ...
        <div class="row mt-5 d-flex">
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-5 ">
                <div data-aos="fade-down" class="card border-0 index-card h-100 h-100">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        <i class="fa fa-fw fa-file-pdf index-big-icon"></i>
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-5">
                <div data-aos="fade-down" class="card border-0 index-card h-100">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        <i class="fa fa-fw fa-users index-big-icon"></i>
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-5">
                <div data-aos="fade-down" class="card border-0 index-card h-100">
                    <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                        <i class="fa fa-fw fa-chart-line index-big-icon"></i>
