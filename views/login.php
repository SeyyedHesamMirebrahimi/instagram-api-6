			...
			<form action="" method="post" role="form">
                ...
                <div class="row">
                    ...
                    <div class="col-sm mt-1">
                        <a href="<?= $facebook_login_url ?>" class="btn btn-primary btn-block"><?= sprintf($language->login->button->facebook, "<i class=\"fab fa-fw fa-facebook fa-lg\"></i>") ?></a>
                    </div>
                    <?php endif ?>

                    <?php if($settings->instagram_login): ?>
                    <div class="col-sm mt-1">
                        <a href="<?= $instagram_login_url ?>" class="btn btn-primary bg-instagram btn-block"><?= sprintf($language->login->button->instagram, "<i class=\"fab fa-fw fa-instagram fa-lg\"></i>") ?></a>
                    </div>
                    <?php endif ?>
                </div>
